...
if [ ! -f "credentials/.env" ]; then
    ...
    echo "   # GIT_HOST=github.com          # gitlab.com, bitbucket.org, etc."
    echo "   # GIT_AUTH_USERNAME=x-access-token  # oauth2 for GitLab"
    echo "   # REGISTRY=ghcr.io             # docker.io, registry.gitlab.com, etc."
    echo "   # REGISTRY_USERNAME=\$USERNAME  # override registry namespace/org"
